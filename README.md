...
* The code is implemented in Python 3 and intentionally avoids using existing libraries.
* The unit tests are written in [py.test](https://docs.pytest.org) and can be run with
```
[path_to_py.test] --vv tests
```
